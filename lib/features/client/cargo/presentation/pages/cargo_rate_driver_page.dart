...
/// Cargo (Pochta) flow — rate-the-courier sheet (Figma node 2189:23979
/// "Haydovchini baholang"). A bottom sheet over the dark scrim: a 5-star
/// rating row, a list of selectable complaint reasons with circular
/// checkboxes, a "leave a comment" field, and the "Etiroz bildirish" /
/// "Saqlash" button pair.
@RoutePage()
class CargoRateDriverPage extends StatefulWidget {
  const CargoRateDriverPage({super.key});

  @override
  State<CargoRateDriverPage> createState() => _CargoRateDriverPageState();
}

class _CargoRateDriverPageState extends State<CargoRateDriverPage> {
  int _rating = 2; // 1-based count of filled stars

  static const _reasons = [
    'cargo.crate_reason_not_door',
    'cargo.crate_reason_no_contact',
    'cargo.crate_reason_not_handed',
    'cargo.crate_reason_other',
    'cargo.crate_reason_other',
    'cargo.crate_reason_other',
  ];
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text('cargo.crate_comment_hint'.tr(),
                              style: TextStyle(
                                  fontSize: 14.sp,
                                  height: 16 / 14,
